...
//==============EMPATE====================================================================================================
    ...
    public void vencedor(String jogadorVencendo){// parâmetro recebe o  valor do argumento da chamada acima .
        if(jogadorVencendo.equals("jogador 1")){ // se o valor do parâmetro for igual a palavra jogador  1 então mostre x vencedor 
            ...
            Resetar();//CHAMADA AO MÉTODO LIMPAR ! SE NÃO FOR REALIZADA A LIMPEZA O JOGO IRÁ CONTAR VITORIA 2 OU MIAS VEZES
    ...
    public void Resetar(){
       ...
       B8.setText("8");
       B9.setText("9");
       jogador1 = true;  // variáves de troca de caractere
       jogador2 = false;
    }
    //====================================================================================================================
    //--------------------------------------------------------------------------------------------------------------------
    ...
    private void B3ActionPerformed(java.awt.event.ActionEvent evt) {                                   
        if(jogador1 == true){
            if(B3.getText().equals("3")){
               ...
               inverSao();
               /*
               SE O JOGADOR 1 FOR VERDADEIRO E SE O TEXTO DE B3 FOR VAZIO ENTÃO
               TROCA POR X. 
...
//------------------------------------------------------------------------------------------------------------------------
    //EVENTO B5!!
    // AO CLICAR NO BOTAL 5  E SE O JOGADOR 1 FOR VERDADEIRO EE O TEXTO DO BOTÃO 5 B5 FOR VAZIO
